...
class VisionMamba(nn.Module):
    ...
    # Modified: ahanaf019@gmail.com
    def forward_features(self, x, inference_params=None, if_random_cls_token_position=False, if_random_token_rank=False, return_all_tokens=False):
        ...
        # Added by ahanaf019@gmail.com
        # ---- NEW: return all tokens (for HPE / geometry tasks) ----
        if return_all_tokens:
            return hidden_states  # [B, N, C]
